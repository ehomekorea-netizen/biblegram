...
const BIBLE_BOOKS_MAP = [
  { idx: 0, name: "Genesis", ko: ["창세기"] },
  { idx: 1, name: "Exodus", ko: ["출애굽기"] },
  { idx: 2, name: "Leviticus", ko: ["레위기"] },
  { idx: 3, name: "Numbers", ko: ["민수기"] },
  { idx: 4, name: "Deuteronomy", ko: ["신명기"] },
  { idx: 5, name: "Joshua", ko: ["여호수아"] },
  { idx: 6, name: "Judges", ko: ["사사기"] },
  { idx: 7, name: "Ruth", ko: ["룻기"] },
  { idx: 8, name: "1 Samuel", ko: ["사무엘상"] },
  { idx: 9, name: "2 Samuel", ko: ["사무엘하"] },
  { idx: 10, name: "1 Kings", ko: ["열왕기상"] },
  { idx: 11, name: "2 Kings", ko: ["열왕기하"] },
  { idx: 12, name: "1 Chronicles", ko: ["역대기상", "역대상"] },
  { idx: 13, name: "2 Chronicles", ko: ["역대기하", "역대하"] },
  { idx: 14, name: "Ezra", ko: ["에스라"] },
  { idx: 15, name: "Nehemiah", ko: ["느헤미야"] },
  { idx: 16, name: "Esther", ko: ["에스더"] },
  { idx: 17, name: "Job", ko: ["욥기"] },
  { idx: 18, name: "Psalms", ko: ["시편"] },
  { idx: 19, name: "Proverbs", ko: ["잠언"] },
  { idx: 20, name: "Ecclesiastes", ko: ["전도서"] },
  { idx: 21, name: "Song of Solomon", ko: ["아가"] },
  { idx: 22, name: "Isaiah", ko: ["이사야"] },
  { idx: 23, name: "Jeremiah", ko: ["예레미야"] },
  { idx: 24, name: "Lamentations", ko: ["예레미야애가", "예레미야 애가"] },
  { idx: 25, name: "Ezekiel", ko: ["에스겔"] },
  { idx: 26, name: "Daniel", ko: ["다니엘"] },
  { idx: 27, name: "Hosea", ko: ["호세아"] },
  { idx: 28, name: "Joel", ko: ["요엘"] },
  { idx: 29, name: "Amos", ko: ["아모스"] },
  { idx: 30, name: "Obadiah", ko: ["오바댜"] },
  { idx: 31, name: "Jonah", ko: ["요나"] },
  { idx: 32, name: "Micah", ko: ["미가"] },
  { idx: 33, name: "Nahum", ko: ["나훔"] },
  { idx: 34, name: "Habakkuk", ko: ["하박국"] },
  { idx: 35, name: "Zephaniah", ko: ["스바냐"] },
  { idx: 36, name: "Haggai", ko: ["학개"] },
  { idx: 37, name: "Zechariah", ko: ["스가랴"] },
  { idx: 38, name: "Malachi", ko: ["말라기"] },
  { idx: 39, name: "Matthew", ko: ["마태복음"] },
  { idx: 40, name: "Mark", ko: ["마가복음"] },
  { idx: 41, name: "Luke", ko: ["누가복음"] },
  { idx: 42, name: "John", ko: ["요한복음"] },
  { idx: 43, name: "Acts", ko: ["사도행전"] },
  { idx: 44, name: "Romans", ko: ["로마서"] },
  { idx: 45, name: "1 Corinthians", ko: ["고린도전서"] },
  { idx: 46, name: "2 Corinthians", ko: ["고린도후서"] },
  { idx: 47, name: "Galatians", ko: ["갈라디아서"] },
  { idx: 48, name: "Ephesians", ko: ["에베소서"] },
  { idx: 49, name: "Philippians", ko: ["빌립보서"] },
  { idx: 50, name: "Colossians", ko: ["골로새서"] },
  { idx: 51, name: "1 Thessalonians", ko: ["데살로니가전서"] },
  { idx: 52, name: "2 Thessalonians", ko: ["데살로니가후서"] },
  { idx: 53, name: "1 Timothy", ko: ["디모데전서"] },
  { idx: 54, name: "2 Timothy", ko: ["디모데후서"] },
  { idx: 55, name: "Titus", ko: ["디도서"] },
  { idx: 56, name: "Philemon", ko: ["빌레몬서"] },
  { idx: 57, name: "Hebrews", ko: ["히브리서"] },
  { idx: 58, name: "James", ko: ["야고보서"] },
  { idx: 59, name: "1 Peter", ko: ["베드로전서"] },
  { idx: 60, name: "2 Peter", ko: ["베드로후서"] },
  { idx: 61, name: "1 John", ko: ["요한일서"] },
  { idx: 62, name: "2 John", ko: ["요한이서"] },
  { idx: 63, name: "3 John", ko: ["요한삼서"] },
  { idx: 64, name: "Jude", ko: ["유다서"] },
  { idx: 65, name: "Revelation", ko: ["요한계시록"] }
];
